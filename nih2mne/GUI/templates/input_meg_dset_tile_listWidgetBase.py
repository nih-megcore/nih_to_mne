# Form implementation generated from reading ui file 'nih2mne/GUI/templates/input_meg_dset_tile_listWidgetBase.ui'
#
...
class Ui_InputDatasetTile(object):
    def setupUi(self, InputDatasetTile):
        ...
        self.frame = QtWidgets.QFrame(parent=InputDatasetTile)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.ReadoutSubjid = QtWidgets.QLabel(parent=self.widget)
        self.ReadoutSubjid.setTextInteractionFlags(QtCore.Qt.TextInteractionFlag.LinksAccessibleByMouse|QtCore.Qt.TextInteractionFlag.TextEditable)
        self.ReadoutSubjid.setObjectName("ReadoutSubjid")
        self.horizontalLayout.addWidget(self.ReadoutSubjid)
        self.ReadoutTaskname = QtWidgets.QLabel(parent=self.widget)
        self.ReadoutTaskname.setTextInteractionFlags(QtCore.Qt.TextInteractionFlag.LinksAccessibleByMouse|QtCore.Qt.TextInteractionFlag.TextEditable)
        self.ReadoutTaskname.setObjectName("ReadoutTaskname")
        self.horizontalLayout.addWidget(self.ReadoutTaskname)
        self.label_Duration = QtWidgets.QLabel(parent=self.widget)
        ...
        self.lbl_StaticProcFile = QtWidgets.QLabel(parent=self.widget_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.ProcFileComboBox = QtWidgets.QComboBox(parent=self.widget_4)
        ...
        self.lbl_EventInfo = QtWidgets.QLabel(parent=self.widget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
