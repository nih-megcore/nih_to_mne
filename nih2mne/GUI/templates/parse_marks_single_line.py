# Form implementation generated from reading ui file 'nih2mne/GUI/templates/parse_marks_single_line.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.combo_LeadSelection = QtWidgets.QComboBox(parent=Form)
        ...
        self.cb_OnLead = QtWidgets.QCheckBox(parent=Form)
        self.cb_OnLead.setObjectName("cb_OnLead")
        self.horizontalLayout.addWidget(self.cb_OnLead)
        self.combo_LagSelection = QtWidgets.QComboBox(parent=Form)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.cb_OnLag = QtWidgets.QCheckBox(parent=Form)
